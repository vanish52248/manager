...
class PartyRegisterView(APIView):
    ...
    def post(self, request):           
        ...
        result_data["currentSelectPokemon1"] = request.data.get("currentSelectPokemon1")
        result_data["currentSelectPokemon2"] = request.data.get("currentSelectPokemon2")
        result_data["currentSelectPokemon3"] = request.data.get("currentSelectPokemon3")
        result_data["currentSelectPokemon4"] = request.data.get("currentSelectPokemon4")
        result_data["currentSelectPokemon5"] = request.data.get("currentSelectPokemon5")
